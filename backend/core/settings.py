...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-sunrise-hotel-12345')
...
DB_ENGINE_ENV = os.getenv('DB_ENGINE', 'sqlite').lower()

if DB_ENGINE_ENV == 'postgresql':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME', 'sunrise_hotel'),
