...
export const tweakcnPresets: Record<string, ThemePreset> = {
  "sunrise-resort-gold": {
    label: "🌅 Sunrise Resort — Warm Navy & Gold",
    styles: {
      light: {
        ...
        popover: "oklch(1 0 0)",
        "popover-foreground": "oklch(0.16 0.03 255)",
        ...
        "sidebar-foreground": "oklch(0.16 0.03 255)",
        "sidebar-primary": "oklch(0.70 0.15 75)",
        "sidebar-primary-foreground": "oklch(0.10 0.03 255)",
        "sidebar-accent": "oklch(0.95 0.015 85)",
        "sidebar-accent-foreground": "oklch(0.20 0.03 255)",
        "sidebar-border": "oklch(0.92 0.01 85)",
        "sidebar-ring": "oklch(0.70 0.15 75)",
      ...
      dark: {
        ...
        ring: "oklch(0.74 0.15 75)",
        "chart-1": "oklch(0.74 0.15 75)",
        "chart-2": "oklch(0.696 0.17 162.48)",
        "chart-3": "oklch(0.769 0.188 70.08)",
        "chart-4": "oklch(0.627 0.265 303.9)",
        "chart-5": "oklch(0.645 0.246 16.439)",
        radius: "0.75rem",
        sidebar: "oklch(0.14 0.03 255)",
        "sidebar-foreground": "oklch(0.98 0.01 85)",
        "sidebar-primary": "oklch(0.74 0.15 75)",
        "sidebar-primary-foreground": "oklch(0.10 0.03 255)",
        "sidebar-accent": "oklch(0.22 0.035 255)",
        "sidebar-accent-foreground": "oklch(0.98 0.01 85)",
        "sidebar-border": "oklch(1 0 0 / 12%)",
        "sidebar-ring": "oklch(0.74 0.15 75)",
        "font-sans": "'Plus Jakarta Sans', system-ui, sans-serif",
        "font-serif": "'Playfair Display', Georgia, serif",
        "font-mono": "ui-monospace, JetBrains Mono, monospace",
      },
  ...
  "sunrise-noir-gold": {
    label: "✦ Sunrise Noir Gold — Black & Gold Luxury",
    styles: {
      light: {
        // Crisp white page surface, pure white cards — like the landing page content area
        background: "oklch(0.97 0.002 80)",
        foreground: "oklch(0.09 0.01 260)",
        card: "oklch(1 0 0)",
        "card-foreground": "oklch(0.09 0.01 260)",
        popover: "oklch(1 0 0)",
        "popover-foreground": "oklch(0.09 0.01 260)",
        // Amber gold primary — exactly the landing page CTA colour
        primary: "oklch(0.72 0.17 76)",
        "primary-foreground": "oklch(0.08 0.01 260)",
        secondary: "oklch(0.94 0.006 80)",
        "secondary-foreground": "oklch(0.15 0.01 260)",
        muted: "oklch(0.94 0.004 80)",
        "muted-foreground": "oklch(0.46 0.01 250)",
        accent: "oklch(0.95 0.018 82)",
        "accent-foreground": "oklch(0.12 0.01 260)",
        destructive: "oklch(0.577 0.245 27.325)",
        "destructive-foreground": "oklch(0.98 0 0)",
        border: "oklch(0.88 0.006 80)",
        input: "oklch(0.88 0.006 80)",
        ring: "oklch(0.72 0.17 76)",
        "chart-1": "oklch(0.72 0.17 76)",
        "chart-2": "oklch(0.60 0.14 160)",
        "chart-3": "oklch(0.50 0.10 250)",
        "chart-4": "oklch(0.78 0.19 82)",
        "chart-5": "oklch(0.65 0.16 68)",
        radius: "0.75rem",
        // Jet black sidebar — exact match to landing page navbar colour
        sidebar: "oklch(0.09 0.01 258)",
        "sidebar-foreground": "oklch(0.93 0.005 80)",
        "sidebar-primary": "oklch(0.72 0.17 76)",
        "sidebar-primary-foreground": "oklch(0.08 0.01 260)",
        "sidebar-accent": "oklch(0.14 0.012 258)",
        "sidebar-accent-foreground": "oklch(0.93 0.005 80)",
        "sidebar-border": "oklch(1 0 0 / 10%)",
        "sidebar-ring": "oklch(0.72 0.17 76)",
        "font-sans": "'Plus Jakarta Sans', system-ui, sans-serif",
        "font-serif": "'Playfair Display', Georgia, serif",
        "font-mono": "ui-monospace, JetBrains Mono, monospace",
      },
      dark: {
        // True near-black page background
        background: "oklch(0.08 0.008 258)",
        foreground: "oklch(0.95 0.004 80)",
        card: "oklch(0.11 0.010 258)",
        "card-foreground": "oklch(0.95 0.004 80)",
        popover: "oklch(0.11 0.010 258)",
        "popover-foreground": "oklch(0.95 0.004 80)",
        // Bright amber gold that pops on black
        primary: "oklch(0.76 0.17 78)",
        "primary-foreground": "oklch(0.07 0.008 258)",
        secondary: "oklch(0.14 0.010 258)",
        "secondary-foreground": "oklch(0.95 0.004 80)",
        muted: "oklch(0.14 0.008 258)",
        "muted-foreground": "oklch(0.64 0.018 76)",
        accent: "oklch(0.16 0.012 258)",
        "accent-foreground": "oklch(0.95 0.004 80)",
        destructive: "oklch(0.704 0.191 22.216)",
        "destructive-foreground": "oklch(0.98 0 0)",
        border: "oklch(1 0 0 / 10%)",
        input: "oklch(1 0 0 / 13%)",
        ring: "oklch(0.76 0.17 78)",
        "chart-1": "oklch(0.76 0.17 78)",
        "chart-2": "oklch(0.696 0.17 162.48)",
        "chart-3": "oklch(0.769 0.188 70.08)",
        "chart-4": "oklch(0.627 0.265 303.9)",
        "chart-5": "oklch(0.645 0.246 16.439)",
        radius: "0.75rem",
        // Pure black sidebar — landing page navbar depth
        sidebar: "oklch(0.055 0.006 258)",
        "sidebar-foreground": "oklch(0.93 0.005 80)",
        "sidebar-primary": "oklch(0.76 0.17 78)",
        "sidebar-primary-foreground": "oklch(0.07 0.008 258)",
        "sidebar-accent": "oklch(0.11 0.010 258)",
        "sidebar-accent-foreground": "oklch(0.93 0.005 80)",
        "sidebar-border": "oklch(1 0 0 / 8%)",
        "sidebar-ring": "oklch(0.76 0.17 78)",
        "font-sans": "'Plus Jakarta Sans', system-ui, sans-serif",
        "font-serif": "'Playfair Display', Georgia, serif",
        "font-mono": "ui-monospace, JetBrains Mono, monospace",
      },
  ...
  // ── Grand Maison Luxury: 7-star resort-grade design system ─────────────────────────────────────
  "grand-maison-luxury": {
    label: "✦ Grand Maison — 7-Star Luxury Resort",
    styles: {
        light: {
          // Warm Silk Ivory — the hallmark of luxury hotel stationery
          background: "oklch(0.982 0.006 90)",
          foreground: "oklch(0.12 0.015 260)",
          card: "oklch(1 0 0)",
          "card-foreground": "oklch(0.12 0.015 260)",
          popover: "oklch(1 0 0)",
          "popover-foreground": "oklch(0.12 0.015 260)",
          // Champagne Gold — oklch equivalent of #C9A84C (the colour of luxury)
          primary: "oklch(0.73 0.13 83)",
          "primary-foreground": "oklch(0.10 0.015 260)",
          secondary: "oklch(0.96 0.008 88)",
          "secondary-foreground": "oklch(0.18 0.015 260)",
          muted: "oklch(0.96 0.006 88)",
          "muted-foreground": "oklch(0.45 0.012 250)",
          // Warm Gold Tinted Accent
          accent: "oklch(0.95 0.018 82)",
          "accent-foreground": "oklch(0.12 0.015 260)",
          destructive: "oklch(0.577 0.245 27.325)",
          "destructive-foreground": "oklch(0.98 0 0)",
          // Soft champagne border — elegant not harsh
          border: "oklch(0.91 0.010 88)",
          input: "oklch(0.91 0.010 88)",
          ring: "oklch(0.73 0.13 83)",
          // Charts — champagne gold spectrum
          "chart-1": "oklch(0.73 0.13 83)",
          "chart-2": "oklch(0.65 0.12 88)",
          "chart-3": "oklch(0.55 0.10 75)",
          "chart-4": "oklch(0.82 0.14 85)",
          "chart-5": "oklch(0.78 0.14 70)",
          // Deep Obsidian Sidebar — the dramatic luxury contrast element
          sidebar: "oklch(0.09 0.012 258)",
          "sidebar-foreground": "oklch(0.90 0.005 85)",
          "sidebar-primary": "oklch(0.73 0.13 83)",
          "sidebar-primary-foreground": "oklch(0.09 0.012 258)",
          "sidebar-accent": "oklch(0.14 0.014 258)",
          "sidebar-accent-foreground": "oklch(0.90 0.005 85)",
          "sidebar-border": "oklch(1 0 0 / 8%)",
          "sidebar-ring": "oklch(0.73 0.13 83)",
          // Cormorant Garamond — editorial luxury serif (Vogue, Chanel, LV, Bvlgari)
          "font-sans": "'DM Sans', system-ui, sans-serif",
          "font-serif": "'Cormorant Garamond', Georgia, serif",
          "font-mono": "'JetBrains Mono', monospace",
          radius: "0.5rem",
          // Refined shadow system
          "shadow-color": "oklch(0.12 0.015 260)",
          "shadow-opacity": "0.08",
          "shadow-blur": "24px",
          "shadow-spread": "0px",
          "shadow-offset-x": "0px",
        ...
        dark: {
          // Pure Deep Obsidian — like a luxury hotel suite at midnight
          background: "oklch(0.09 0.012 258)",
          foreground: "oklch(0.96 0.005 85)",
          card: "oklch(0.12 0.014 258)",
          "card-foreground": "oklch(0.96 0.005 85)",
          popover: "oklch(0.12 0.014 258)",
          "popover-foreground": "oklch(0.96 0.005 85)",
          // Radiant Champagne Gold — glows beautifully on obsidian
          primary: "oklch(0.76 0.14 83)",
          "primary-foreground": "oklch(0.09 0.012 258)",
          secondary: "oklch(0.16 0.014 258)",
          "secondary-foreground": "oklch(0.96 0.005 85)",
          muted: "oklch(0.14 0.012 258)",
          // Warm gold-tinted muted foreground
          "muted-foreground": "oklch(0.62 0.018 82)",
          accent: "oklch(0.18 0.016 82)",
          "accent-foreground": "oklch(0.96 0.005 85)",
          destructive: "oklch(0.704 0.191 22.216)",
          "destructive-foreground": "oklch(0.98 0 0)",
          // Subtle champagne shimmer borders
          border: "oklch(1 0 0 / 8%)",
          input: "oklch(1 0 0 / 10%)",
          ring: "oklch(0.76 0.14 83)",
          // Charts — champagne gold spectrum on dark
          "chart-1": "oklch(0.76 0.14 83)",
          "chart-2": "oklch(0.696 0.17 162.48)",
          "chart-3": "oklch(0.769 0.188 70.08)",
          "chart-4": "oklch(0.627 0.265 303.9)",
          "chart-5": "oklch(0.645 0.246 16.439)",
          // Even deeper obsidian sidebar for dramatic depth
          sidebar: "oklch(0.065 0.010 258)",
          "sidebar-foreground": "oklch(0.92 0.005 85)",
          "sidebar-primary": "oklch(0.76 0.14 83)",
          "sidebar-primary-foreground": "oklch(0.065 0.010 258)",
          "sidebar-accent": "oklch(0.11 0.012 258)",
          "sidebar-accent-foreground": "oklch(0.92 0.005 85)",
          "sidebar-border": "oklch(1 0 0 / 7%)",
          "sidebar-ring": "oklch(0.76 0.14 83)",
          // Cormorant Garamond — editorial luxury serif (Vogue, Chanel, LV, Bvlgari)
          "font-sans": "'DM Sans', system-ui, sans-serif",
          "font-serif": "'Cormorant Garamond', Georgia, serif",
          "font-mono": "'JetBrains Mono', monospace",
          radius: "0.5rem",
          // Refined shadow system for dark mode
          "shadow-color": "oklch(0.05 0.01 258)",
          "shadow-opacity": "0.40",
          "shadow-blur": "32px",
          "shadow-spread": "0px",
          "shadow-offset-x": "0px",
