...
export default function AppearanceSettings() {
  ...
  function onSubmit(data: AppearanceFormValues) {
    ...
    toast.success("Appearance settings updated!", {
      description: `Application theme has been set to ${data.theme}.`,
    })
  }

  return (
    <BaseLayout title="Appearance Settings" description="Customize the appearance of the application.">
                    ...
                    >
                      ...
                      <FormItem>
                        <FormLabel className="[&:has([data-state=checked])>div]:border-primary cursor-pointer">
                          ...
                          <div className="rounded-md border-2 border-muted p-4 hover:border-accent transition-colors">
                            <div className="space-y-2">
                              <div className="w-20 h-20 bg-gradient-to-br from-zinc-100 to-zinc-950 border rounded-md p-3">
                                <div className="space-y-2">
                                  <div className="h-2 bg-zinc-400 rounded w-3/4"></div>
                                  <div className="h-2 bg-zinc-400 rounded w-1/2"></div>
                                  <div className="flex space-x-2">
                                    <div className="h-2 w-2 bg-zinc-500 rounded-full"></div>
                                    <div className="h-2 bg-zinc-400 rounded flex-1"></div>
                                  </div>
                                </div>
                              </div>
