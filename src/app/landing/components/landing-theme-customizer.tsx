...
import { RotateCcw, Settings, X, Dices, Upload, Sun, Moon } from 'lucide-react'
...
export function LandingThemeCustomizer({ open, onOpenChange }: LandingThemeCustomizerProps) {
  ...
  const handleReset = () => {
    const next = { selectedTheme: "default", selectedTweakcnTheme: "", selectedRadius: "0.5rem", importedTheme: null }
    setConfig(next)
    saveCustomizerConfig(next)
    setBrandColorsValues({})
    resetTheme()
  ...
  const handleRandomShadcn = () => {
    ...
    const next = { selectedTheme: randomTheme.value, selectedTweakcnTheme: "", selectedRadius, importedTheme: null }
    setConfig(next)
    saveCustomizerConfig(next)
    setBrandColorsValues({})
  ...
  const handleRandomTweakcn = () => {
    ...
    const next = { selectedTheme: "", selectedTweakcnTheme: randomTheme.value, selectedRadius, importedTheme: null }
    setConfig(next)
    saveCustomizerConfig(next)
    setBrandColorsValues({})
