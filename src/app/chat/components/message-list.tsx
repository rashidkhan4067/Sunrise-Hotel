                ...
                return (
                  ...
                  >
                    ...
                    <div className={cn("flex-1 max-w-[70%]", isOwnMessage && "flex flex-col items-end")}>
                      ...
                      {/* Message bubble */}
                      <div className={cn(
                        "relative group/message flex items-center gap-2 max-w-full",
                        ...
                        {/* Message actions */}
                        <div className="opacity-100 lg:opacity-0 lg:group-hover/message:opacity-100 transition-opacity shrink-0">
                          <DropdownMenu>
